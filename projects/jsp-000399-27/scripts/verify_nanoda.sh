...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000399Triple -- \
  JSP000399Triple.complex_counterexample JSP000399Triple.not_unique_27_triples \
...
config = {
    ...
    "pp_declars": ["JSP000399Triple.witness", "JSP000399Triple.reflected",
                   "JSP000399Triple.complexSumMultiset",
                   "JSP000399Triple.complex_counterexample",
