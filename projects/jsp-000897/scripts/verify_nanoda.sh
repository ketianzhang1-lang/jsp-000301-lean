...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000897 -- \
  Erdos1079.erdos_problem_1079 Erdos1079.erdos_1079 \
  JSP000897.surplus_at_every_maximum JSP000897.resolution_with_surplus \
  JSP000897.surplus_dominates JSP000897.strict_resolution \
...
config = {
    ...
    "pp_declars": ["Erdos1079.cliqueExtremalNumber", "Erdos1079.edgeCount",
                   "Erdos1079.linkEdgeCount", "JSP000897.resolution_with_surplus"],
