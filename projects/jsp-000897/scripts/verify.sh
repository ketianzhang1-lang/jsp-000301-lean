...
lake env leanchecker Erdos1079 2>&1 | tee evidence/kernel-upstream.log
lake env leanchecker JSP000897 2>&1 | tee evidence/kernel-main.log
...
print('Eight target axiom audits and all nine dependency revision checks passed.')
PY
printf 'import JSP000897\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
