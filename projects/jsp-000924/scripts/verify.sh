...
lake env leanchecker JSP000924 2>&1 | tee evidence/leanchecker.log
...
print('All six axiom audits and all actual dependency revisions passed.')
PY
printf 'import JSP000924\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
...
python3 scripts/crosscheck.py | tee evidence/crosscheck.log
