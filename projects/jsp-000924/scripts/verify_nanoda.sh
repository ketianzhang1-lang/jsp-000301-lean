...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000924 -- \
  JSP000924.sophie_germain_proper_divisor JSP000924.family_proper_divisor \
  JSP000924.family_sierpinski JSP000924.candidate_sierpinski \
  JSP000924.infinitely_many_fourth_powers JSP000924.standard_list_not_cover > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={
  ...
  'pp_declars':['JSP000924.Sierpinski','JSP000924.member','JSP000924.root','JSP000924.seed',
    'JSP000924.modulus','JSP000924.standardPrimes','JSP000924.family_proper_divisor',
    'JSP000924.family_sierpinski','JSP000924.candidate_sierpinski',
    'JSP000924.infinitely_many_fourth_powers','JSP000924.standard_list_not_cover'],
