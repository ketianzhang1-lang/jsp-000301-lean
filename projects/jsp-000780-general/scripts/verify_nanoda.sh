...
lake env "$work/exporter/.lake/build/bin/lean4export" Adapter -- \
  JSP000780General.solution_for_every_parameter \
  JSP000780General.infinitely_many_solutions \
  JSP000780General.infinitely_many_totals \
  JSP000780General.original_all_r_infinite \
  JSP000780General.original_every_parameter > evidence/export.ndjson
python3 - <<'PY'
import json
...
config = {
    ...
    "pp_declars": ["JSP000780General.OriginalSolutions",
                   "JSP000780General.FactorFull",
                   "JSP000780General.original_all_r_infinite"],
