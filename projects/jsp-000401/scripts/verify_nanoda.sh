...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000401 -- \
  JSP000401.turan_lower_bound JSP000401.total_edges \
...
config = {
    ...
    "pp_declars": ["JSP000401.Good", "JSP000401.GoodSet", "JSP000401.edges",
                   "JSP000401.Valid", "JSP000401.turan_lower_bound"],
