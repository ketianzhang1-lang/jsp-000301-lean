...
lake env leanchecker JSP000554 2>&1 | tee evidence/kernel.log
...
print('All 12 target axiom audits and all dependency revision checks passed.')
PY
printf 'import JSP000554\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
