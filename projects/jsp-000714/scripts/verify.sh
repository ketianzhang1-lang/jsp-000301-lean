...
lake env leanchecker JSP000714 2>&1 | tee evidence/kernel.log
...
print('All 9 target axiom audits and all dependency revision checks passed.')
PY
printf 'import JSP000714\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
