...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000746 -- "${targets[@]}" > "$evidence/export.ndjson"
...
report = {
    ...
    'module': 'JSP000746', 'targets': (out / 'targets.txt').read_text().splitlines(),
