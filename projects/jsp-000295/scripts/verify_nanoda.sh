...
lake env "$work/exporter/.lake/build/bin/lean4export" Compatibility -- \
  JSP000295.entry_hasDistinctSums JSP000295.lower_bound JSP000295.real_lower_bound \
  Erdos357.erdos_357.variants.weisenberg Erdos357.explicit_lower_bound \
...
config = {
    ...
    "pp_declars": ["JSP000295.HasDistinctSums", "JSP000295.f", "JSP000295.entry",
                   "JSP000295.lower_bound", "JSP000295.weisenberg",
                   "Erdos357.erdos_357.variants.weisenberg"],
