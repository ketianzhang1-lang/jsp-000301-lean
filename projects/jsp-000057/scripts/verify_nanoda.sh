...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000057 -- \
  JSP000057.matching_of_card JSP000057.seven_forces_three JSP000057.twoTriangles_no_three JSP000057.threshold_iff JSP000057.seven_forces_three_sets JSP000057.twoTriangles_sets_no_three JSP000057.original_threshold_iff JSP000057.f_two_three > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={
  ...
  'pp_declars':['JSP000057.matching_of_card', 'JSP000057.seven_forces_three', 'JSP000057.twoTriangles_no_three', 'JSP000057.threshold_iff', 'JSP000057.seven_forces_three_sets', 'JSP000057.twoTriangles_sets_no_three', 'JSP000057.original_threshold_iff', 'JSP000057.f_two_three'],
