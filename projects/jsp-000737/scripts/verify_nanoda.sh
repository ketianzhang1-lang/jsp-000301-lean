...
lake env "$work/exporter/.lake/build/bin/lean4export" Compatibility -- \
  JSP000737.short_interval_bound JSP000737.rosenfeld_bound \
  Erdos886.erdos_886.variants.rosenfeld_bound \
...
config = {
    ...
    "pp_declars": ["JSP000737.short_interval_bound", "JSP000737.rosenfeld_bound",
                   "Erdos886.erdos_886.variants.rosenfeld_bound"],
