...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000925Strict -- \
  JSP000925Strict.strict_gap_theorem JSP000925Strict.exists_unique_strict_gaps > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={
  ...
  'pp_declars':['JSP000925Strict.RightGapStrict','Erdos1114.GapSymmetric',
    'JSP000925Strict.strict_gap_theorem','JSP000925Strict.exists_unique_strict_gaps'],
