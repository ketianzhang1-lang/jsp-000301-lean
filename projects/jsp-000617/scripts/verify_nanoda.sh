...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000617Cover -- \
  ...
  JSP000617.finite_plane_construction > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={'export_file_path':'evidence/export.ndjson','use_stdin':False,
        ...
        'pp_declars':['JSP000617.finite_plane_construction','JSP000617.exists_small_uncovered'],
