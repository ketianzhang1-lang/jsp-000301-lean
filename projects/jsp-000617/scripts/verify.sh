...
lake env leanchecker JSP000617 2>&1 | tee evidence/leanchecker-core.log
lake env leanchecker JSP000617Cover 2>&1 | tee evidence/leanchecker-cover.log
...
for f in ['JSP000617.lean','JSP000617Cover.lean']:
...
print('All nine actual target-axiom reports and nine dependency pins checked.')
PY
printf 'import JSP000617Cover\nexample : (1 : Nat) = 0 := by decide\n' > NegativeControl.lean
