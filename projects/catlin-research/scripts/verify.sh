...
for module in Certificate GraphCore Profile Subdivision Colouring Catlin; do
...
print('All nine axiom audits and all actual dependency revisions passed.')
PY
printf 'import Catlin\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
