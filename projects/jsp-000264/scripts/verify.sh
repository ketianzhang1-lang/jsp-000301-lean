...
lake env leanchecker JSP000264 2>&1 | tee evidence/leanchecker.log
...
print('All four axiom audits and all actual dependency revisions passed.')
PY
printf 'import JSP000264\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
