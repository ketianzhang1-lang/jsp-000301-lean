...
lake env leanchecker Erdos16 2>&1 | tee evidence/upstream-kernel.log
lake env leanchecker Erdos16Density 2>&1 | tee evidence/supplement-kernel.log
lake env leanchecker Alignment 2>&1 | tee evidence/alignment-kernel.log
...
print('Supplement SHA256:',hashlib.sha256(Path('Erdos16Density.lean').read_bytes()).hexdigest())
PY
printf 'import Erdos16Density\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
