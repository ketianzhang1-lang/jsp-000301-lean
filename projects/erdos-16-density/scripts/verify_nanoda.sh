...
lake env "$work/exporter/.lake/build/bin/lean4export" Alignment -- \
  Erdos16Density.no_decomposition_positive_exponent Erdos16Reference.erdos_16 > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={
  ...
  'pp_declars':['Erdos16Density.NaturalDensityZero','Erdos16Density.Exceptional',
    'Erdos16Reference.DensityZero','Erdos16Reference.ExceptionalSet',
    'Erdos16Density.no_decomposition_positive_exponent','Erdos16Reference.erdos_16'],
