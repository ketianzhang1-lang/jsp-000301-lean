...
# Export the stated targets and all their transitive dependencies, not unrelated
# declarations from the imported tactic environment. No dependency is omitted.
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000390 -- \
  JSP000390.three_pow_succ_dvd JSP000390.three_pow_is_solution \
  JSP000390.minus_one_unbounded JSP000390.minus_one_infinite \
  JSP000390.minus_one_infinite_unrestricted > evidence/export.ndjson
python3 - <<'PY'
import json
...
config = {
    ...
    "pp_declars": ["JSP000390.Solutions", "JSP000390.three_pow_succ_dvd",
                   "JSP000390.minus_one_unbounded", "JSP000390.minus_one_infinite"],
