...
module='JSP000465Uniform'
pin='6a793b157c1afdf29f3e6bbbf3cf514535d1dfca'
prefix='projects/jsp-000465'
...
if len(targets)!=12 or len(set(targets))!=12:raise SystemExit('Unexpected audit targets')
