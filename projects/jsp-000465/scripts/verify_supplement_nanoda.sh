...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000465Uniform -- "${targets[@]}" > "$evidence/export.ndjson"
...
report = {
    ...
    'module': 'JSP000465Uniform', 'targets': (out / 'targets.txt').read_text().splitlines(),
