...
lake env "$work/exporter/.lake/build/bin/lean4export" Compatibility -- \
  JSP000883.factorial_multiple_admissible JSP000883.infinitely_many_starting_points \
  JSP000883.least_bounds Erdos1063.erdos_1063.variants.monier_upper_bound \
  Erdos1063.original_least_is_admissible \
...
config = {
    ...
    "pp_declars": ["JSP000883.Admissible", "JSP000883.n",
                   "JSP000883.factorial_multiple_admissible",
                   "JSP000883.infinitely_many_starting_points",
