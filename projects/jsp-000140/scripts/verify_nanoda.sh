...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000140 -- \
  JSP000140.fork_packing JSP000140.strict_lower_bound \
  JSP000140.integer_lower_bound JSP000140.lower_bound_from_vertex_sets \
...
config = {
    ...
    "pp_declars": ["JSP000140.Admissible", "JSP000140.edgeColors",
                   "JSP000140.fork_packing", "JSP000140.strict_lower_bound",
                   "JSP000140.integer_lower_bound", "JSP000140.lower_bound_from_vertex_sets"],
