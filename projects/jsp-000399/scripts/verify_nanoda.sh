...
lake env "$work/exporter/.lake/build/bin/lean4export" Compatibility -- \
  JSP000399.equal_triple_sums_nat JSP000399.not_unique_27 \
  Erdos494.card_27_counterexample > evidence/export.ndjson
python3 - <<'PY'
import json
...
config={
  ...
  'pp_declars':['JSP000399.A','JSP000399.B','JSP000399.natSums',
    'JSP000399.Unique','JSP000399.not_unique_27','Erdos494.sumMultiset',
    'Erdos494.Erdos494Unique','Erdos494.card_27_counterexample'],
