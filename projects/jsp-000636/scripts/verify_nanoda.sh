...
lake env "$work/exporter/.lake/build/bin/lean4export" OriginalQuestion -- \
  ...
  JSP000636.threshold_lower_bound JSP000636.attaining_family \
  ...
  JSP000636.original_threshold_question JSP000636.jsp_000636 \
