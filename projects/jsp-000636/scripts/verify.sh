...
for module in JSP000636 Lower Upper Construction Threshold Thinning Asymptotics OriginalQuestion; do
...
source = '\n'.join(Path(f).read_text() for f in ['JSP000636.lean', 'Lower.lean', 'Upper.lean', 'Construction.lean', 'Threshold.lean', 'Thinning.lean', 'Asymptotics.lean', 'OriginalQuestion.lean'])
...
print('All 79 theorem axiom audits and dependency pins passed.')
PY
printf 'import OriginalQuestion\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
