...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000530 -- \
  JSP000530.counterexample_family JSP000530.not_asymptotically_all_distances \
...
config = {
    ...
    "pp_declars": ["JSP000530.NoFourConcyclic", "JSP000530.distanceValues",
                   "JSP000530.counterexample_family",
                   "JSP000530.not_asymptotically_all_distances"],
