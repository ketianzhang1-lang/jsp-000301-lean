...
lake env leanchecker JSP000530 2>&1 | tee evidence/kernel-main.log
...
print('Six target axiom audits and all nine dependency revision checks passed.')
PY
printf 'import JSP000530\nexample : (1 : Nat) = 0 := by decide\n' > Negative.lean
