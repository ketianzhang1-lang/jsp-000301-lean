...
lake env "$work/exporter/.lake/build/bin/lean4export" JSP000391Main -- \
  JSP000391.sequence_closed_forms JSP000391.recurrence_extracts_digits \
  JSP000391.digit_bounds JSP000391.multipliers \
  JSP000391.stoll_general_base JSP000391.jsp000391 > evidence/export.ndjson
python3 - <<'PY'
import json
...
config = {
    ...
    "pp_declars": ["JSP000391.sequence", "JSP000391.a", "JSP000391.b",
                   "JSP000391.normalized", "JSP000391.digit", "JSP000391.digitPrefix",
                   "JSP000391.stoll_general_base", "JSP000391.jsp000391"],
